...
class WC_GZDP_Install {
	...
	public function welcome_notice() {
		...
		} elseif ( get_option( '_wc_gzdp_invoice_dir_rename_failed' ) ) {
			include_once( WC_germanized_pro()->plugin_path() . '/includes/admin/views/html-invoice-dir-rename-error.php' );
			delete_option( '_wc_gzdp_invoice_dir_rename_failed' );
		}
	}
	...
	public function update() {
		...
		elseif ( version_compare( $current_db_version, '1.8.0', '<' ) )
			$this->upgrade_invoice_path_suffix();
		elseif ( version_compare( $current_db_version, '1.8.6', '<' ) )
			$this->upgrade_fonts_path_suffix();
	...
	public function upgrade_fonts_path_suffix() {
	...
	public function upgrade_invoice_path_suffix() {
