...
class WC_GZDP_Theme_Flatsome extends WC_GZDP_Theme {
	...
	public function custom_hooks() {
		...
		if ( has_action( 'woocommerce_single_product_summary', 'woocommerce_gzd_template_single_legal_info' ) )
			add_action( 'woocommerce_single_product_lightbox_summary', 'woocommerce_gzd_template_single_legal_info', 12 );

		if ( has_action( 'woocommerce_single_product_summary', 'woocommerce_gzd_template_single_delivery_time_info' ) )
